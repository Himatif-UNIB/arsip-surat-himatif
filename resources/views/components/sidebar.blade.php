<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('home') }}" class="app-brand-link d-flex flex-column align-items-center mt-3">
            <img src="https://himatifunib.org/storage/156/himatif-6000_small.png" alt="{{ config('app.name') }}"
                width="35">
            <h5 class="text-center mt-2">{{ config('app.name') }}</h5>
        </a>
